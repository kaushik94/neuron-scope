...
# Configuration
MODEL_PATH = "/path/to/your/llama/model"  # Update with your model path
LAYER_INDEX = 2  # Layer to probe (0-based indexing)
...
def load_model_and_tokenizer():
    ...
    try:
        quantization_config = {"load_in_4bit": True}  # Optional: Use 4-bit quantization
